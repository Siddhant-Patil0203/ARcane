      ...
      <div className="flex flex-col m-9 space-y-5">
        ...
        <div className="lg:col-start-2 col-end-3 lg:ml-5 sm:ml-3 sm:mr-3 pt-4 lg:pt-0 col-start-1">
          ...
          <p className="text-small text-foreground/80">
            ...
            Charkop, Mumbai. Take the experience of contemporary living to a new
            high, with exquisitely designed apartments at Mapkhan Lilac Garden.
            This flat for resale is a choice property. This contemporary
